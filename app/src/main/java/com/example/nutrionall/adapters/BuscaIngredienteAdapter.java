...
public class BuscaIngredienteAdapter extends ArrayAdapter<Food> {

    private final Context context;
    private final ArrayList<Food> elementos;

    public BuscaIngredienteAdapter(Context context, ArrayList<Food> elementos){
        super(context, R.layout.layout_busca_ingrediente,elementos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.layout_busca_ingrediente, parent, false);

        TextView nomeAlimento = (TextView) rowView.findViewById(R.id.txtLayoutBuscaIngredienteNome);
        TextView categoriaAlimento = (TextView) rowView.findViewById(R.id.txtLayoutBuscaIngredienteCategoria);
        TextView energiaAlimento = (TextView) rowView.findViewById(R.id.txtLayoutBuscaIngredienteEnergia);
        TextView carboidratoAlimento = (TextView) rowView.findViewById(R.id.txtLayoutBuscaIngredienteCarboidrato);
        ImageView imagemCategoriaAlimento = (ImageView) rowView.findViewById(R.id.imgLayoutBuscaIngredienteImgCategoria);
